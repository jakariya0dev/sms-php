<nav class="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="teacher-list">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="teacher-all.php">All Teacher</a></li>
          <li class="nav-item"> <a class="nav-link" href="teacher-add.php">Add New Teacher</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item menu-items">
      <a class="nav-link" data-bs-toggle="collapse" href="#speech-menu" aria-expanded="false" aria-controls="ui-basic">
        ...
        <span class="menu-title">Speech</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="speech-menu">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="speech-president.php">President Speech</a></li>
          <li class="nav-item"> <a class="nav-link" href="speech-principal.php">Principal Speech</a></li>
        </ul>
      </div>
    </li>
    ...
    <!--  Academic Corner -->
    <li class="nav-item menu-items">
      <a class="nav-link" data-bs-toggle="collapse" href="#academic-corner" aria-expanded="false" aria-controls="ui-basic">
        <span class="menu-icon">
          <i class="mdi mdi-laptop"></i>
        </span>
        <span class="menu-title">Academic Corner</span>
        <i class="menu-arrow"></i>
      </a>
      <div class="collapse" id="academic-corner">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="academic-all.php">All Links</a></li>
          <li class="nav-item"> <a class="nav-link" href="academic-add.php">Add Links</a></li>
        </ul>
      </div>
    </li>
